...
import os, sys, subprocess, psutil, smtplib
from time import gmtime, strftime


#email configuration
from_addr='protsenkovetal@gmail.com'
to_addr_list='protsenkovetal@gmail.com'
cc_addr_list='protsenkovetal@gmail.com'
...
def cpu_total():
	...
	f.write(str(time())+"\t CPU usage total = "+str(output)+"\n")
...
def cpu_per_core():
	...
	f=open('/home/v/dev/utools/scrip_log.1', 'a')
	f.write(str(time())+"\t CPU usage per core = "+str(output)+"\n")
...
def memory():
	...
	f=open('/home/v/dev/utools/scrip_log.1', 'a')
	f.write(str(time())+"\t Memory usage = "+str(output)+"\n")
...
def swap():
	...
	f=open('/home/v/dev/utools/scrip_log.1', 'a')
	f.write(str(time())+"\t SWAP usage = "+str(output)+"\n")
...
def disc():
	...
	f=open('/home/v/dev/utools/scrip_log.1', 'a')
	f.write(str(time())+"\t disc usage = "+str(output)+"\n")
